<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Default3.aspx.cs" Inherits="MyfirstWebApp.Default3" %>
...
<body>
    <form id="form1" runat="server">
        <div>
            <asp:Label ID="lblSelected" runat="server" Text="Date"></asp:Label>
            <br />
            <br />
